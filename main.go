...
func main() {
	...
	flag.StringVar(&engine.DnsxList, "dnsx-list", "", "Absolute path to wordlist for active dnsx bruteforcing (Full Mode only)")
	flag.StringVar(&engine.DirectoryList, "directory-list", "", "Absolute path to wordlist for directory fuzzing")
